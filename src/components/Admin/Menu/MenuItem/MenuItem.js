...
export function MenuItem(props) {
    ...
    //estados de activar,desactivar,eliminar
    ...
    const openUpdateMenu = () => {
        setTitleModal(`Actializar menu: ${menu.title}`)
        onOpenCloseModal();
    };
    ...
    const onActivateDesactive = async () => {
        try {
    ...
    return (
        <>
            ...
            <Confirm
                ...
                onConfirm={isDelete ? onDelete : onActivateDesactive}
